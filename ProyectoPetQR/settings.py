"""
Django settings for ProyectoPetQR project.
...
SECRET_KEY = 'sim(90dat5qrenz%8p&-xqjlfpz$(06(o%(rwji%ef*h)v6tr%'
...
ROOT_URLCONF = 'ProyectoPetQR.urls'
...
WSGI_APPLICATION = 'ProyectoPetQR.wsgi.application'
